...
TEST_CASE("EOS EVM codedeposit test") {
    ...
    gas_params.values_.G_codedeposit = 500;
...
TEST_CASE("EOS EVM G_txnewaccount") {
    ...
    evmone::gas_parameters gas_params;
    gas_params.values_.G_txnewaccount = 0;
    ...
    txn.to = receiver2;
    gas_params.values_.G_txnewaccount = 1;
...
TEST_CASE("EOS EVM G_txnewaccount v3") {
    ...
    evmone::gas_parameters gas_params;
    gas_params.values_.G_txnewaccount = 1000;
...
TEST_CASE("EOS EVM send value to reserved address (tx)") {
    ...
    gas_params.values_.G_txnewaccount = 5000;
